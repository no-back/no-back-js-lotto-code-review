describe("lotto-domain-test", () => {
  ...
  it("엔터 키 입력 시 로또 구입 금액이 1000 이하인 경우 modal 경고를 띄운다.", () => {});
  it("엔터 키 입력 시 로또 구입 금액이 100000 이상인 경우 modal 경고를 띄운다. ", () => {});
  ...
  // click event
  it("확인버튼 클릭 시 로또 구입 금액이 1000 이하인 경우 modal 경고를 띄운다.", () => {});
  it("확인버튼 클릭 시 로또 구입 금액이 100000 이상인 경우 modal 경고를 띄운다. ", () => {});
